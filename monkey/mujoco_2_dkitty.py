...
i = 0
while True:  
    # for idx, data i%n enumerate(datas) :
    # sim.data.body_xpos = [0 0 10]

    data = datas[i] 
    sim.data.ctrl[0] = -0.2   # actuator ID 10 
    sim.data.ctrl[1] = data[4]                         # actuator ID 11``
    sim.data.ctrl[2] = data[5]                         # actuator ID 12
     

    sim.data.ctrl[3] = 0.2      # actuator ID 21      # actuator ID 20  (actuqcwactor degree which is abs(45) bounded by .mjcf)
    sim.data.ctrl[4] = data[6]  # actuator ID 22
    sim.data.ctrl[5] = data[7]  # actuator ID 12
     

    sim.data.ctrl[6] = 0.2       # actuator ID 40
    sim.data.ctrl[7] = data[2]   # actuator ID 41
    sim.data.ctrl[8] = data[3]   # actuator ID 42
    

    sim.data.ctrl[9] = -0.2          # actuator ID 10
    sim.data.ctrl[10] = data[0]    # actuator ID 11
    sim.data.ctrl[11] = data[1]    # actuator ID 12
